...
\section{Antibodies}
  ...
  \subsection{Immunoglobulin Genetics}
    ...
    \begin{core}[label=core:l_chain_gene]{L Chain Gene Sequences}
      ...
      % ORIGINAL: The light chain gene sequences are seperated into the λ and κ versions.
    ...
    \subsubsection{L/H Chain Gene Expression}
      ...
      \begin{core}[label=core:ll_chain_gene_expression]{λ L Chain Gene Expression}
        ...
        \begin{enumerate}[label=(\arabic*)]
          ...
          \item \textbf{REARRANGEMENT} [Rearranged Gene] --- \textit{Nucleus}
            ...
            }{Recombination signal sequences flanking the V and J segments during λ light gene rearrangement}{fig:ll_expression2}{0.9}
      ...
      \begin{core}[label=core:kl_chain_gene_expression]{κ L Chain Gene Expression}
        ...
        \begin{enumerate}[label=(\arabic*)]
          ...
          \item \textbf{REARRANGEMENT} [Rearranged Gene] --- \textit{Nucleus}
            ...
            }{Recombination signal sequences flanking the V and J segments during κ light chain gene rearrangement}{fig:kl_expression2}{0.9}
      ...
      \begin{core}{H Chain Gene Expression}
        ...
        \begin{enumerate}[label=(\arabic*)]
          ...
          \item \textbf{REARRANGEMENT} [Rearranged Gene] --- \textit{Nucleus}
            ...
            }{Recombination signal sequences flanking the V, D, and J segments during heavy chain gene rearrangement}{fig:rss3}{0.85}
      ...
      \begin{core}[label=core:rss]{RSS Joining Mechanism}
      ...
      \begin{core}{Immunoglobulin DNA to Expression Pathway}
        ...
        core env about the steps the DNA takes from the 
        nucleus
        ribosomes
        RER
        Golgi
        vesicles
        to memebrane (surface receptos) or ECM (secretion)
