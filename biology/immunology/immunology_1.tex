...
\section{Immune System Players}
  ...
  \begin{core}{Hematopoietic Stem Cells (HSCs) \& Lineage}
    ...
    \autoref{fig:hsc_lineage} illustrates the hierarchical differentiation of haematopoietic stem cells (HSCs) into the myeloid and lymphoid lineages, highlighting the key transcription factors that govern lineage commitment at each branch point.
  ...
  \begin{core}{Lymphoid Lineage}
    ...
    \textit{It's important to note that nearly all nucleated cells in the human body express \textbf{Major Histocompatibility Complex (MHC) class I} (\autoref{core:mhc_characteristics}) molecules on their surfaces. These molecules are critical for the presentation of antigens to CD8+ cytotoxic T cells.}
  ...
  \begin{core}{Follicular Dendritic Cells}
    ...
    Follicular Dendritic Cells
      ...
      % FDCs do not arise through hematopoiesis but rather through a mesenchymal origin
      Unlike most immune cells, follicular dendritic cells (FDCs) do not arise via hematopoiesis; rather, they originate from a mesenchymal lineage.

      % Mesenchymal Origin: FDCs are believed to develop from mesenchymal progenitor cells during embryogenesis. These progenitors are distinct from the hematopoietic progenitors.
      Mesenchymal Origin: FDCs develop from mesenchymal progenitor cells during embryogenesis, which are entirely distinct from hematopoietic progenitors.

      % Migration: FDCs migrate into the lymphoid tissue during its development and become embedded in the follicles of secondary lymphoid organs.
      Migration: FDCs migrate into developing lymphoid tissues and ultimately embed themselves within the follicles of secondary lymphoid organs.

      % Antigen Retention: FDCs are unique for their ability to retain and present antigens on their surface for extended periods. They capture antigens from the lymph and retain them in the form of immune complexes, which are critical for B cell activation and the formation of germinal centers.
      Antigen Retention: FDCs are characterized by their unique capacity to retain and present intact antigens on their surfaces for extended durations. They capture antigens from the lymph, holding them as immune complexes that are essential for B cell activation and germinal center formation.

      % Surface Markers
      Surface Markers

        % CD21/CD35: FDCs express complement receptors such as CD21 and CD35, which are important for their role in antigen capture.
        CD21/CD35: FDCs express complement receptors, including CD21 and CD35, which facilitate their role in antigen capture.

        % FDC-M1: A marker specifically associated with FDCs, distinguishing them from other cell types in lymphoid tissues.
        FDC-M1: This marker is specifically associated with FDCs, allowing them to be distinguished from other cellular populations within lymphoid tissues.
...
\section{Immune System Organs}
  ...
  \begin{core}{Primary Immune System Organs}
    ...
    \begin{enumerate}
      ...
      \item \textbf{Bone Marrow} 

        <FIGURE>

        % Location of hematopoietic stem cells (HSCs)
        Primary location of hematopoietic stem cells (HSCs).
        % Full development of all myeloid cells, NK cells, and B cells
        Site for the complete maturation of all myeloid cells, natural killer (NK) cells, and B cells.
        % Initial development of T cells
        Serves as the site for the initial developmental stages of T cells.
        % Major sites are femur, humerus, hip bones, and sternum
      ...
      \item \textbf{Thymus}
        ...
        % Site of T cell maturation and development
        The primary site for T cell maturation and development.

        % Maturation process
        Maturation Process:
          % Cell rearrange genes for TCR (T cell receptor) in the cortex
          Cells undergo gene rearrangement to form the T cell receptor (TCR) within the thymic cortex.
          % Positive Selection: [CORTEX; outer] check for MHC I antigen recognition 
          Positive Selection: Occurs in the outer cortex, testing the cells for functional recognition of MHC class I molecules.
          % Negative Selection: [MEDULLA; inner] check for over reactive MHC I antigen recognition (prevention of autoimmunity)
          Negative Selection: Occurs in the inner medulla, eliminating cells that exhibit over-reactive recognition of MHC class I self-antigens to prevent autoimmunity.

        % Cells that survive the process (less than 95%) enter the circulation—if not → apoptosis
        Cells that successfully survive this selection process enter systemic circulation; the vast majority that fail undergo apoptosis.

        % Apoptosis is different from necrosis in that apoptosis is a much more controlled process and thus much easier to clean up. Necrosis, on the other hand, is analogous to blowing up a building, making it much harder to clean up after.
        Apoptosis is distinct from necrosis due to its highly controlled nature, allowing for efficient cellular clearance. In contrast, necrosis is a disruptive and unregulated process, making the resulting cellular debris significantly more difficult for the body to clear.
  ...
  \begin{core}{Secondary Immune System Organs}
    ...
    \begin{enumerate}
      ...
      \item \textbf{Lymph Sysstem: Fluids, Vessels, Nodes}

        <FIGURE>

        \begin{itemize}

          \item \textit{Vessel \& Fluid}

            % The lymph system is a one-way trip from the body’s tissue to the heart (and back into the bloodstream)
            The lymphatic system functions as a unidirectional transport network from the peripheral tissues back to the heart, eventually returning fluid to the bloodstream.

            % Vessels drain interstitial fluid—picking up antigens and white blood cells—and provides transportation of immune cells but no RBCs
            Lymphatic vessels drain interstitial fluid, collecting antigens and leukocytes in the process. They facilitate the transportation of immune cells but are devoid of red blood cells (RBCs).

            % Lymph is filtered through lymph nodes
            Lymph fluid undergoes filtration as it passes through the lymph nodes.

          \item \textit{Nodes}

            % Lymph nodes [1] trap antigen and [2] provides a place for lymphocytes to interact with those antigens
            Lymph nodes serve two primary functions: they trap incoming antigens and provide a localized environment for lymphocytes to interact with these antigens.

            % Response Pathway
            Response Pathway:

              % APCs enter the lymph through the afferent lymphatic vessels
              Antigen-presenting cells (APCs) enter the lymph node via the afferent lymphatic vessels.

              % Antigen is presented to and activates effector T cells—forming TH and TC cells—in the paracortex of the node
              Antigens are presented to effector T cells within the paracortex of the node, leading to their activation and subsequent differentiation into T helper (TH) and cytotoxic T (TC) cells.

              % T cells activate B cells in the cortex of the node
              Activated T cells then migrate to stimulate B cells located in the cortex of the lymph node.

              % Activated lymphocytes exit through the efferent lymphatic vessels, entering the bloodstream through the thoracic duct towards the subclavian vein and towards the infection
      ...
      \item \textbf{Spleen}
        ...
        <FIGURE>
          ...
          Functions strictly to filter blood, as opposed to lymph.

          % Tissue Types
          Tissue Types:

            % Red Pulp: Recycle RBCs and platelets from circulation through macrophage phagocytosis
            Red Pulp: Responsible for recycling senescent RBCs and platelets from circulation via macrophage-mediated phagocytosis.

            % White Pulp: Key site for immune activation and response; forms structures known as periarteriolar lymphoid sheaths (PALS) and lymphoid follicles—which have T and B cells respectively
            White Pulp: A crucial site for immune activation, organized into periarteriolar lymphoid sheaths (PALS) primarily containing T cells, and lymphoid follicles primarily containing B cells.

          % Removing the spleen can increase a person’s risk for bacterial infections
          Surgical removal of the spleen can significantly elevate an individual's susceptibility to bacterial infections.

      \item \textbf{Mucosa Associated Lymphoid Tissues (MALT)}

        <FIGURE>

        % MALT is refers to the lymphoid tissues found in various mucosal surfaces of the body—gastrointestinal, respiratory, nasal
        MALT refers to the collection of lymphoid tissues situated across various mucosal surfaces, including the gastrointestinal, respiratory, and nasal tracts.

        % Mucosa major systems represents major pathogen entry sites
        These major mucosal systems represent the primary sites of pathogen entry into the body.

        % Organized structures of the MALT include tonsils, appendix, and Peyer’s patches in the intestine
        Highly organized MALT structures include the tonsils, the appendix, and Peyer’s patches located in the intestinal tract.

        % M cells are large epithelial cells—present in the localized areas of lymphoid concentration throughout the MALT—each with a number of smaller immune cells residing in its basolateral pocket
        Microfold (M) cells are specialized large epithelial cells located in areas of localized lymphoid concentration throughout the MALT. Each M cell possesses a basolateral pocket that houses several smaller immune cells.

        % Epithelial cells of the mucosa 
        Epithelial Cells of the Mucosa:

          % Deliver antigen samples from the lumen (space inside bodily vessels) through these M cells
          They facilitate the transport of antigen samples from the lumen across the epithelial barrier via the specialized M cells.

          % Secrete tears, mucus, lysozyme to tear up bacterial membranes
          ...
          % Sweep out pathogen and debris in cilia (for lungs and reproductive organs)
    ...
    \begin{enumerate}
      ...
      \item \textbf{Skin} 
        ...
        Innate Defense Mechanisms:
          ...
          % Epithelial cells of the outer layer (called keratinocytes) secrete cytokines that activate innate immune cells in the area
          ...
          % When dead, keratinocytes leave behind keratin intermediate filament as a protective barrier
          Upon cell death, keratinocytes leave behind a protective physical barrier composed of keratin intermediate filaments.

          % Epidermis—oil gland/hair follicles secrete sebum, antibacterial peptides, and psoriasin (an antimicrobial peptide; AMP) to kill bad and promote good bacteria
          ...
          % Dermis—deeper and thicker mesenchymal and connective tissue important for blood supply and development
        ...
        Adaptive Defense Mechanisms:
          ...
          % Keratinocytes (expresses [MHC II]) and Langerhan cells (skin DCs) activate TH cells
          Keratinocytes (capable of expressing MHC class II) and Langerhans cells (specialized dendritic cells of the skin) present antigens to activate TH cells.

          % There also intra-epidermal lymphocytes (specialized group of T cells) that roam
...
\section{Innate Immunity Processes}
  ...
  \subsection{Inflammation}
    ...
    \begin{core}{Inflammation}
      ...
      % Inflammation is a primary response that involves marshaling the whole immune system to fight a new pathogen threat.
    ...
    \begin{core}{Fever \& The Local Response}
      ...
      % Hypothalamus controls the body’s temperature set point which provides overt sign of immune up-regulation (associated with a better survival rate)
      The hypothalamus regulates the body's baseline temperature; fever serves as an overt systemic indicator of immune up-regulation, a response historically correlated with improved survival rates during infection.

      % Any type of injury, even internal, triggers local inflammatory response
      Any form of tissue injury, including internal trauma, inherently triggers a localized inflammatory response.

      % Involves swelling (tissue leaks), redness (blood flow), heating up, and pain
      This process is characterized by classical signs: swelling (due to vascular leakage), redness (due to increased local blood flow), localized heat, and pain.

      % Helps prevent any actions that worsen injury
      These physiological changes collectively discourage physical behaviors that might exacerbate the initial injury.
