...
\section{Complement System}
  ...
  \subsection{MAC Complex Attack}
    ...
    \begin{core}[label=core:mac_complex]{MAC Complex Attack}
      ...
      }{Membrane attack complex (MAC); \textit{all different complement pathways converge to this pathway}; (A) \textit{C5b is unstable when left unbound}; (B) \textit{C7 recruitment exposes a hydrophobic site that anchors the complex to the membrane}; (C) \textit{C8 recruitment drives partial insertion of the complex into the lipid bilayer}}{fig:mac}{0.9}
      \vspace{-0.4cm}
  ...
  \subsection{Complement Pathways}
    ...
    \begin{core}[label=core:complement_classical]{Classical Pathway}
      ...
      \pgfig{
        ...
        \node[font=\sffamily\small\bfseries, anchor=north] at (1.45,2.1)
          {Anaphylatoxin};
        \draw[process] (c3a.south) -- (1.45,2.05);
        \node[note] at (3.5,1.8) {(C)};
      ...
      }{Classical complement pathway activation cascade; (A) \textit{activated C1r cleaves C1s, producing an active protease}; (B) \textit{C4a is a weak anaphylatoxin}; (C) \textit{C3b also functions as an \textbf{opsonin}, coating targets for phagocytic recognition}}{fig:classical_pathway}{0.9}
    ...
    \begin{core}[label=core:complement_alternative]{Alternative Pathway}
      ...
      \pgfig{
        ...
        \node[font=\sffamily\small\bfseries, anchor=north] at (1.55,3)
          {Anaphylatoxin};
        \draw[process] (c3aalt.south) -- (1.55,2.95);
        ...
        \node[note, anchor=west] at (6,3.42) {(C)};
      ...
      }{Alternative complement pathway activation cascade; (A) \textit{factor Ba diffuses away}; (B) \textit{C3b also serves as an \textbf{opsonin}, coating activating surfaces}; (C) \textit{factor B binding and factor D cleavage of factor B into Bb}; (D) \textit{properdin---sometimes called factor F--- binds and stabilizes C3bBb on the activating surface}}{fig:alternative_pathway}{0.9}
      ...
      \begin{enumerate}
        ...
        \item \textbf{Inflammation} (\textit{Anaphylatoxin})
          ...
          \begin{itemize}
            ...
            \item \textit{C3a}: C3a promotes inflammatory signaling and can stimulate mast-cell and basophil degranulation, thereby contributing to increased vascular permeability.

            % \item \textit{C5a}: Summons macrophages and neutrophils
            \item \textit{C5a}: C5a is a potent anaphylatoxin and chemoattractant that recruits and activates neutrophils, monocytes, and other myeloid cells.
        ...
        \item \textbf{Coating}
          ...
          \begin{itemize}
            ...
            \item \textit{Opsonization}: Covalently deposited complement fragments, particularly C3b and iC3b, coat microbial surfaces and enhance their recognition and phagocytosis through complement receptors.
            ...
            \item \textit{Viral Neutralization}: Complement deposition can sterically hinder viral attachment or entry, promote virion aggregation, and facilitate clearance by phagocytes.
            ...
            \item \textit{Immune-Complex Clearance}: Complement-tagged antigen--antibody complexes bind complement receptor 1 on erythrocytes and are transported through the circulation to the liver and spleen, where phagocytes remove and degrade them.
