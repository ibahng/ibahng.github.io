  ...
  \subsection{Kinetic Molecular Theory}
    ...
    \begin{core}{Kinetic Molecular Theory}
      ...
      \begin{enumerate}
        ...
        \item Gas particles are in \textbf{constant, random motion} and travel in \textbf{straight lines} until they collide with another particle or the walls of the container.

        \item The particles themselves are so small compared to the space between them that their \textbf{individual volume is considered negligible} relative to the total volume of the gas.

        \item Particles \textbf{do not attract or repel one another}; there are no intermolecular forces between gas particles.

        \item Collisions between particles, and between particles and the walls of the container, are \textbf{perfectly elastic}, meaning no kinetic energy is lost during a collision.

        \item The \textbf{average kinetic energy} of the particles is \textbf{directly proportional to the absolute (Kelvin) temperature} of the gas, and all gases at the same temperature have the same average kinetic energy.
    ...
    \begin{core}[label=core:max_boltz_dis]{Maxwell-Boltzmann Distribution}
      ...
      The \textbf{Maxwell-Boltzmann distribution} describes the distribution of molecular speeds in a gas sample at a given temperature. As \text{temperature} increases, distribution broadens, indicating a wider range of speeds.
