...
\section{Conjugated Systems} % lessons 1-3
  ...
  \subsection{Organic Acids \& Bases Review}
    ...
    \begin{core}{Acidity of Alkanes, Alkenes, and Alkynes}
      ...
      We now examine the trend in pK$_\text{a}$ values of alkanes, alkenes, and alkynes. The linear pattern observed can be rationalized by considering the following factors.
      ...
      \pgfig{
        ...
        \begin{scope}[xshift=4.5cm]
          ...
          \node at (0.7,0.3) {$C\,(sp)$};
        \end{scope}
      }{Diagram of $\text{sp}^3$, $\text{sp}^2$, and sp orbital energy levels; \textit{lone pair in the sp orbital is most stabilized because the relatively greater s character increases the probabilityof \ce{e^-}s residing closer to the positive charge of the nucleus}}{fig:ph3a}{0.8}
  ...
  \subsection{Allylic Systems}
    ...
    \begin{core}{Allylic System Resonance}
      ...
      An allylic hydrogen exhibits greater acidity than both alkane and alkyne hydrogens, as resonance delocalizes the negative charge across the resulting allylic anion, thereby rendering the anion a comparatively weaker base.
      ...
      }{K$_\text{eq}$s of alkane (\textit{top}) vs allylic (\textit{bottom}) hydrogens; \textit{the K$_\text{eq}$ of the allylic scenario is much more forward-favoring because it is able to better stabilize the negative carboanion charge}}{fig:ph11a}{0.72}
      \vspace{-0.5cm}
    ...
    \begin{core}{Allylic System Bond Dissociation Energy}
      ...
      }{Non-allylic (\textit{top}) vs allylic (\textit{bottom}) leaving group primary carbocation formation viability; \textit{a primary carbocation can form in the bottom reaction because the cation is additionally allylic}; \textit{Ts stands for a tosyl group, a common chemical group used in organic synthesis}}{fig:ph15a}{0.9}
    ...
    \begin{core}{Allylic System Molecular Orbital Structure}
      ...
      \pgfig{
        ...
        \draw[blue, rotate=15] (-0.95,1.15) ellipse (0.2cm and 0.6cm);
        \draw[blue, rotate=15] (-0.95,-0.25) ellipse (0.2cm and 0.6cm);
      }{σ bond orbitals overlap along internuclear axis (handshake) whereas π bond orbitals overlap above and below internuclear axes. All carbons are sp$^2$ hybridized}{fig:ph17a}{0.9}
      ...
      This distinction is particularly relevant in the context of \textbf{frontier molecular orbital theory}, which holds that the HOMO of a nucleophile interacts with the LUMO of an electrophile (\textit{or vice versa}) as explored in the context of the Diels--Alder reaction (\autoref{core:da_orbitals}).
  ...
  \subsection{Conjugated π Systems}
    ...
    \begin{core}{Conjugated π System Stability}
      ...
      \myfig{0.65}{conj_sys_figures/conj_edia}{Energy diagrams of non-conjugated (\textit{left}) and conjugated (\textit{right}) π systems in alkadienes from \autoref{fig:ph22a}; \textit{the source of stability in a conjugated π system is the lowest π MO \ce{e^-}s}}{fig:ph23a}
      \vspace{-0.4cm}

      The governing principles for conjugated π system orbital energy diagrams are as follows.
      ...
      \[
        \text{resonance} > 3^\circ > 2^\circ > 1^\circ
      \]
    ...
    \begin{core}[label=core:chlorination_example]{Chlorination of Conjugated Cycloalkene}
      ...
      }{Top attack (\textit{left}) and bottom attack (\textit{right}) leading to corresponding chloronium intermediates}{fig:ph25a}{0.85}
      ...
      }{Electrophilic carbons on chloronium intermediate}{fig:ph27a}{0.9}
    ...
    \begin{core}{Radical Bromination of Terminal Alkene}
      ...
      }{N-Bromo-succinimide allows the slow release of \ce{Br2} to avoid alkenes adding \ce{Br2} directly}{fig:ph31a}{0.85}
      \vspace{-0.2cm}
